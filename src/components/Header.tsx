...
function Header(){
    return <header className="flex flex-row px-14 py-5">
        ...
        <button className="ml-auto background-dark py-2 px-20 text-white select-none rounded-lg text-xl">Связаться</button>
